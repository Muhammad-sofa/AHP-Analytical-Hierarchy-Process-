...
<head>
    ...
    <title>Lovely Corpin Tour & Travel >> Edit Data Alternatif</title>
                            ...
                            <div class="panel-body">
                                <form role="form" method="post" action="edit.php?id=<?php echo $_GET['id']; ?>">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Harga Terhadap Fasilitas</label>
                                            <input type="text" class="form-control" name="k1" id="k1" value="<?php echo $row["k1"]; ?>" placeholder="Nilai Bobot">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Harga Terhadap Banyak Tujuan Wisata</label>
                                            <input type="text" class="form-control" name="k2" id="k2" value="<?php echo $row["k2"]; ?>" placeholder="Nilai Bobot">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Harga Terhadap Lama Wisata</label>
                                            <input type="text" class="form-control" name="k3" id="k3" value="<?php echo $row["k3"]; ?>" placeholder="Nilai Bobot">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Fasilitas Terhadap Bayak Tujuan Wisata</label> <input type="text" class="form-control" name="k4" id="k4" value="<?php echo $row["k4"]; ?>" placeholder="Nilai Bobot">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Fasilitas Terhadap Lama Wisata</label>
                                            <input type="text" class="form-control" name="k5" id="k5" value="<?php echo $row["k5"]; ?>" placeholder="Nilai Bobot">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Bayak Tujuan Wisata Terhadap Lama Wisata</label>
                                            <input type="text" class="form-control" name="k6" id="k6" value="<?php echo $row["k6"]; ?>" placeholder="Nilai Bobot">
                                        </div>
                                    </div><!-- /.box-body -->
